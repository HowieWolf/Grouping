...
class GroupingConstant {
    // 文件后缀
    static final String FILE_SUFFIX = "api"
    static final String SERVICE_MODULE = "groupingServiceModule"
    static final String GROUPING_COMPONENTS = "groupingComponents"
